...
[![License: multiple](https://img.shields.io/badge/License-multiple-blue.svg)](COPYING)
...
This project was created primarily to provide early access to NSIS 64-bit features.  
It also includes several additional plugins and features you may find useful.

### Features:
- Native `x86` and `amd64` NSIS compilers
- Can create native `x86` and `amd64` installers compatible with all Windows versions (NT4+)
